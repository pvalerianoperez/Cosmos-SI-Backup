...
namespace Cosmos.Api.Client.Compras
{
    ...
    {
        public static Cosmos.Entidades.Compras.Proveedor ConsultarCompleto(int proveedorID)
        {
            ...
            try
            {
                string url = string.Format("{0}/api/Compras/Proveedor/ConsultarCompleto", AppGlobals.ApiURL);
