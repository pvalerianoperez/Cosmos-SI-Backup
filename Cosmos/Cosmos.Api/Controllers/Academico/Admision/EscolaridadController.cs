...
namespace Cosmos.Api.Controllers.Academico.Admision
{
    public class EscolaridadController : ApiController
    {
        ...
        [HttpPost]
        [Route("api/Academico/Admision/Escolaridad/Listado")]
        ...
        public RespuestaBase Listado(SolicitudBase solicitud)
        {
            ...
            try
            {
                ...
                if (Funciones.AccesoValido(solicitud))
                {
                    ...
                    respuesta.Datos = Cosmos.Academico.Admision.Negocio.Escolaridad.Listado();
                }
                else
                {
        ...
        [HttpPost]
        [Route("api/Academico/Admision/Escolaridad/Guardar")]
        [JWTAuthorize(PermissionCatalogue.NONE)]
        public RespuestaBase Guardar(SolicitudBase solicitud)
        {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud))
                {
                    ...
                    Cosmos.Academico.Admision.Entidades.Escolaridad o = JsonConvert.DeserializeObject<Cosmos.Academico.Admision.Entidades.Escolaridad>(JsonConvert.SerializeObject(solicitud.Datos));
                    //prepara la respuesta
                    respuesta.CodigoRespuesta = 1;
                    respuesta.MensajeRespuesta = "OK";
                    respuesta.CodigoError = 0;
                    respuesta.MensajeError = "";
                    respuesta.Exitoso = true;
                    respuesta.Datos = new List<Cosmos.Academico.Admision.Entidades.Escolaridad>() { Cosmos.Academico.Admision.Negocio.Escolaridad.Guardar(o, oDataForLog) };
                }
                else
                {
                    throw new Exception("Acceso inválido.");
        ...
        [HttpPost]
        [Route("api/Academico/Admision/Escolaridad/Eliminar")]
        [JWTAuthorize(PermissionCatalogue.NONE)]
        public RespuestaBase Eliminar(SolicitudBase solicitud)
        {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud))
                {
                    ...
                    respuesta.CodigoError = 0;
                    respuesta.MensajeError = "";
                    respuesta.Exitoso = Cosmos.Academico.Admision.Negocio.Escolaridad.Eliminar(o.EscolaridadID, oDataForLog);
                    respuesta.Datos = null;
                }
                else
                {
        ...
        [HttpPost]
        [Route("api/Academico/Admision/Escolaridad/Consultar")]
        [JWTAuthorize(PermissionCatalogue.NONE)]
        public RespuestaBase Consultar(SolicitudBase solicitud)
        {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud))
                {
                    ...
                    respuesta.MensajeError = "";
                    respuesta.Exitoso = true;
                    respuesta.Datos = new List<Cosmos.Academico.Admision.Entidades.Escolaridad>() { Cosmos.Academico.Admision.Negocio.Escolaridad.Consultar(o) };
                }
                else
                {
                    throw new Exception("Acceso inválido.");
