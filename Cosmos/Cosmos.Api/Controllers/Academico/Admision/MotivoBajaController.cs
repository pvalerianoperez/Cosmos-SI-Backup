...
{
    public class MotivoBajaController : ApiController
    {
        #region CRUD

        [HttpPost]
        [Route("api/Academico/Admision/MotivoBaja/Listado")]
        ...
        public RespuestaBase Listado(SolicitudBase solicitud)
        {
            ...
            try
            {
                ...
                if (Funciones.AccesoValido(solicitud))
                {
                    ...
                    respuesta.Datos = Cosmos.Academico.Admision.Negocio.MotivoBaja.Listado();
                }
                else
                {
        ...
        [HttpPost]
        [Route("api/Academico/Admision/MotivoBaja/Guardar")]
        [JWTAuthorize(PermissionCatalogue.NONE)]
        public RespuestaBase Guardar(SolicitudBase solicitud)
        {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud))
                {
                    ...
                    Cosmos.Academico.Admision.Entidades.MotivoBaja o = JsonConvert.DeserializeObject<Cosmos.Academico.Admision.Entidades.MotivoBaja>(JsonConvert.SerializeObject(solicitud.Datos));
                    //prepara la respuesta
                    respuesta.CodigoRespuesta = 1;
                    respuesta.MensajeRespuesta = "OK";
                    respuesta.CodigoError = 0;
                    respuesta.MensajeError = "";
                    respuesta.Exitoso = true;
                    respuesta.Datos = new List<Cosmos.Academico.Admision.Entidades.MotivoBaja>() { Cosmos.Academico.Admision.Negocio.MotivoBaja.Guardar(o, oDataForLog) };
                }
                else
                {
                    throw new Exception("Acceso inválido.");
        ...
        [HttpPost]
        [Route("api/Academico/Admision/MotivoBaja/Eliminar")]
        [JWTAuthorize(PermissionCatalogue.NONE)]
        public RespuestaBase Eliminar(SolicitudBase solicitud)
        {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud))
                {
                    ...
                    respuesta.CodigoError = 0;
                    respuesta.MensajeError = "";
                    respuesta.Exitoso = Cosmos.Academico.Admision.Negocio.MotivoBaja.Eliminar(o.MotivoBajaID, oDataForLog);
                    respuesta.Datos = null;
                }
                else
                {
        ...
        [HttpPost]
        [Route("api/Academico/Admision/MotivoBaja/Consultar")]
        [JWTAuthorize(PermissionCatalogue.NONE)]
        public RespuestaBase Consultar(SolicitudBase solicitud)
        {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud))
                {
                    ...
                    respuesta.MensajeError = "";
                    respuesta.Exitoso = true;
                    respuesta.Datos = new List<Cosmos.Academico.Admision.Entidades.MotivoBaja>() { Cosmos.Academico.Admision.Negocio.MotivoBaja.Consultar(o) };
                }
                else
                {
                    throw new Exception("Acceso inválido.");
