...
namespace Cosmos.Api.Controllers.Academico.Admision
{
    public class ParentescoController : ApiController
    {
        ...
        [HttpPost]
        [Route("api/Academico/Admision/Parentesco/Listado")]
        ...
        public RespuestaBase Listado(SolicitudBase solicitud)
        {
            ...
            try
            {
                ...
                if (Funciones.AccesoValido(solicitud))
                {
                    ...
                    respuesta.Datos = Cosmos.Academico.Admision.Negocio.Parentesco.Listado();
                }
                else
                {
        ...
        [HttpPost]
        [Route("api/Academico/Admision/Parentesco/Guardar")]
        [JWTAuthorize(PermissionCatalogue.NONE)]
        public RespuestaBase Guardar(SolicitudBase solicitud)
        {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud))
                {
                    ...
                    Cosmos.Academico.Admision.Entidades.Parentesco o = JsonConvert.DeserializeObject<Cosmos.Academico.Admision.Entidades.Parentesco>(JsonConvert.SerializeObject(solicitud.Datos));
                    //prepara la respuesta
                    respuesta.CodigoRespuesta = 1;
                    respuesta.MensajeRespuesta = "OK";
                    respuesta.CodigoError = 0;
                    respuesta.MensajeError = "";
                    respuesta.Exitoso = true;
                    respuesta.Datos = new List<Cosmos.Academico.Admision.Entidades.Parentesco>() { Cosmos.Academico.Admision.Negocio.Parentesco.Guardar(o, oDataForLog) };
                }
                else
                {
                    throw new Exception("Acceso inválido.");
        ...
        [HttpPost]
        [Route("api/Academico/Admision/Parentesco/Eliminar")]
        [JWTAuthorize(PermissionCatalogue.NONE)]
        public RespuestaBase Eliminar(SolicitudBase solicitud)
        {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud))
                {
                    ...
                    respuesta.CodigoError = 0;
                    respuesta.MensajeError = "";
                    respuesta.Exitoso = Cosmos.Academico.Admision.Negocio.Parentesco.Eliminar(o.ParentescoID, oDataForLog);
                    respuesta.Datos = null;
                }
                else
                {
        ...
        [HttpPost]
        [Route("api/Academico/Admision/Parentesco/Consultar")]
        [JWTAuthorize(PermissionCatalogue.NONE)]
        public RespuestaBase Consultar(SolicitudBase solicitud)
        {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud))
                {
                    ...
                    respuesta.MensajeError = "";
                    respuesta.Exitoso = true;
                    respuesta.Datos = new List<Cosmos.Academico.Admision.Entidades.Parentesco>() { Cosmos.Academico.Admision.Negocio.Parentesco.Consultar(o) };
                }
                else
                {
                    throw new Exception("Acceso inválido.");
