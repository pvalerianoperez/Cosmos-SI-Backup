...
{
    public class CicloController : ApiController
    {
        #region CRUD

        [HttpPost]
        [Route("api/Academico/Ciclo/Listado")]
        ...
        public RespuestaBase Listado(SolicitudBase solicitud)
        {
            ...
            try
            {
                ...
                if (Funciones.AccesoValido(solicitud))
                {
                    ...
                    respuesta.Datos = Cosmos.Academico.Negocio.Ciclo.Listado();
                }
                else
                {
        ...
        [HttpPost]
        [Route("api/Academico/Ciclo/Guardar")]
        [JWTAuthorize(PermissionCatalogue.NONE)]
        public RespuestaBase Guardar(SolicitudBase solicitud)
        {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud))
                {
                    ...
                    Cosmos.Academico.Entidades.Ciclo o = JsonConvert.DeserializeObject<Cosmos.Academico.Entidades.Ciclo>(JsonConvert.SerializeObject(solicitud.Datos));
                    //prepara la respuesta
                    respuesta.CodigoRespuesta = 1;
                    respuesta.MensajeRespuesta = "OK";
                    respuesta.CodigoError = 0;
                    respuesta.MensajeError = "";
                    respuesta.Exitoso = true;
                    respuesta.Datos = new List<Cosmos.Academico.Entidades.Ciclo>() { Cosmos.Academico.Negocio.Ciclo.Guardar(o, oDataForLog) };
                }
                else
                {
                    throw new Exception("Acceso inválido.");
        ...
        [HttpPost]
        [Route("api/Academico/Ciclo/Eliminar")]
        [JWTAuthorize(PermissionCatalogue.NONE)]
        public RespuestaBase Eliminar(SolicitudBase solicitud)
        {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud))
                {
                    ...
                    respuesta.CodigoError = 0;
                    respuesta.MensajeError = "";
                    respuesta.Exitoso = Cosmos.Academico.Negocio.Ciclo.Eliminar(o.CicloID, oDataForLog);
                    respuesta.Datos = null;
                }
                else
                {
        ...
        [HttpPost]
        [Route("api/Academico/Ciclo/Consultar")]
        [JWTAuthorize(PermissionCatalogue.NONE)]
        public RespuestaBase Consultar(SolicitudBase solicitud)
        {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud))
                {
                    ...
                    respuesta.MensajeError = "";
                    respuesta.Exitoso = true;
                    respuesta.Datos = new List<Cosmos.Academico.Entidades.Ciclo>() { Cosmos.Academico.Negocio.Ciclo.Consultar(o) };
                }
                else
                {
                    throw new Exception("Acceso inválido.");
