...
{
    public partial class DocumentoController : ApiController
    {
        #region CRUD

        [HttpPost]
        [Route("api/Academico/Documento/Listado")]
        ...
        public RespuestaBase Listado(SolicitudBase solicitud)
        {
            ...
            try
            {
                ...
                if (Funciones.AccesoValido(solicitud))
                {
                    ...
                    respuesta.Datos = Cosmos.Academico.Negocio.Documento.Listado();
                }
                else
                {
        ...
        [HttpPost]
        [Route("api/Academico/Documento/Guardar")]
        [JWTAuthorize(PermissionCatalogue.NONE)]
        public RespuestaBase Guardar(SolicitudBase solicitud)
        {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud))
                {
                    ...
                    Cosmos.Academico.Entidades.Documento o = JsonConvert.DeserializeObject<Cosmos.Academico.Entidades.Documento>(JsonConvert.SerializeObject(solicitud.Datos));
                    //prepara la respuesta
                    respuesta.CodigoRespuesta = 1;
                    respuesta.MensajeRespuesta = "OK";
                    respuesta.CodigoError = 0;
                    respuesta.MensajeError = "";
                    respuesta.Exitoso = true;
                    respuesta.Datos = new List<Cosmos.Academico.Entidades.Documento>() { Cosmos.Academico.Negocio.Documento.Guardar(o, oDataForLog) };
                }
                else
                {
                    throw new Exception("Acceso inválido.");
        ...
        [HttpPost]
        [Route("api/Academico/Documento/Eliminar")]
        [JWTAuthorize(PermissionCatalogue.NONE)]
        public RespuestaBase Eliminar(SolicitudBase solicitud)
        {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud))
                {
                    ...
                    respuesta.CodigoError = 0;
                    respuesta.MensajeError = "";
                    respuesta.Exitoso = Cosmos.Academico.Negocio.Documento.Eliminar(o.DocumentoID, oDataForLog);
                    respuesta.Datos = null;
                }
                else
                {
        ...
        [HttpPost]
        [Route("api/Academico/Documento/Consultar")]
        [JWTAuthorize(PermissionCatalogue.NONE)]
        public RespuestaBase Consultar(SolicitudBase solicitud)
        {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud))
                {
                    ...
                    respuesta.MensajeError = "";
                    respuesta.Exitoso = true;
                    respuesta.Datos = new List<Cosmos.Academico.Entidades.Documento>() { Cosmos.Academico.Negocio.Documento.Consultar(o) };
                }
                else
                {
                    throw new Exception("Acceso inválido.");
