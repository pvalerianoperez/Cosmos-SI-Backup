...
namespace Cosmos.Api.Controllers.Academico
{
    public class OfertaAcademicaController : ApiController
    {
        ...
        [HttpPost]
        [Route("api/Academico/OfertaAcademica/Listado")]
        ...
        public RespuestaBase Listado(SolicitudBase solicitud)
        {
            ...
            try
            {
                ...
                if (Funciones.AccesoValido(solicitud))
                {
                    ...
                    respuesta.Datos = Cosmos.Academico.Negocio.OfertaAcademica.Listado();
                }
                else
                {
        ...
        [HttpPost]
        [Route("api/Academico/OfertaAcademica/Guardar")]
        [JWTAuthorize(PermissionCatalogue.NONE)]
        public RespuestaBase Guardar(SolicitudBase solicitud)
        {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud))
                {
                    ...
                    Cosmos.Academico.Entidades.OfertaAcademica o = JsonConvert.DeserializeObject<Cosmos.Academico.Entidades.OfertaAcademica>(JsonConvert.SerializeObject(solicitud.Datos));
                    //prepara la respuesta
                    respuesta.CodigoRespuesta = 1;
                    respuesta.MensajeRespuesta = "OK";
                    respuesta.CodigoError = 0;
                    respuesta.MensajeError = "";
                    respuesta.Exitoso = true;
                    respuesta.Datos = new List<Cosmos.Academico.Entidades.OfertaAcademica>() { Cosmos.Academico.Negocio.OfertaAcademica.Guardar(o, oDataForLog) };
                }
                else
                {
                    throw new Exception("Acceso inválido.");
        ...
        [HttpPost]
        [Route("api/Academico/OfertaAcademica/Eliminar")]
        [JWTAuthorize(PermissionCatalogue.NONE)]
        public RespuestaBase Eliminar(SolicitudBase solicitud)
        {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud))
                {
                    ...
                    respuesta.CodigoError = 0;
                    respuesta.MensajeError = "";
                    respuesta.Exitoso = Cosmos.Academico.Negocio.OfertaAcademica.Eliminar(o.OfertaAcademicaID, oDataForLog);
                    respuesta.Datos = null;
                }
                else
                {
        ...
        [HttpPost]
        [Route("api/Academico/OfertaAcademica/Consultar")]
        [JWTAuthorize(PermissionCatalogue.NONE)]
        public RespuestaBase Consultar(SolicitudBase solicitud)
        {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud))
                {
                    ...
                    respuesta.MensajeError = "";
                    respuesta.Exitoso = true;
                    respuesta.Datos = new List<Cosmos.Academico.Entidades.OfertaAcademica>() { Cosmos.Academico.Negocio.OfertaAcademica.Consultar(o) };
                }
                else
                {
                    throw new Exception("Acceso inválido.");
