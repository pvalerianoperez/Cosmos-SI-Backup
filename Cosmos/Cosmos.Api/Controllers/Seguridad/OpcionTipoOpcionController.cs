...
{
    public partial class OpcionTipoOpcionController : ApiController
    {
        #region CRUD
        
        [HttpPost]
        [Route("api/Seguridad/OpcionTipoOpcion/Listado")]
        public RespuestaBase Listado(SolicitudBase solicitud) {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud)) {
                    ...
                    respuesta.Datos = Cosmos.Seguridad.Negocio.OpcionTipoOpcion.Listado();
                }else{
        ...
        [HttpPost]
        [Route("api/Seguridad/OpcionTipoOpcion/Guardar")]
        public RespuestaBase Guardar(SolicitudBase solicitud)
        {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud)) {                    
                    ...
                    respuesta.CodigoError = 0;
                    respuesta.MensajeError = "";
                    respuesta.Exitoso = Cosmos.Seguridad.Negocio.OpcionTipoOpcion.Guardar(solicitud.UsuarioID, o);
                    respuesta.Datos = null;
                }else{
                    throw new Exception("Acceso inválido.");
                }
        ...
        [HttpPost]
        [Route("api/Seguridad/OpcionTipoOpcion/Eliminar")]
        public RespuestaBase Eliminar(SolicitudBase solicitud)
        {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud)) {                    
                    ...
                    respuesta.CodigoError = 0;
                    respuesta.MensajeError = "";
                    respuesta.Exitoso = Cosmos.Seguridad.Negocio.OpcionTipoOpcion.Eliminar(solicitud.UsuarioID, o);
                    respuesta.Datos = null;
                }else{
                    throw new Exception("Acceso inválido.");
                }
        ...
        [HttpPost]
        [Route("api/Seguridad/OpcionTipoOpcion/Consultar")]
        public RespuestaBase Consultar(SolicitudBase solicitud) {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud)) {                    
                    ...
                    respuesta.MensajeError = "";
                    respuesta.Exitoso = true;
                    respuesta.Datos = new List<Cosmos.Seguridad.Entidades.OpcionTipoOpcion>(){Cosmos.Seguridad.Negocio.OpcionTipoOpcion.Consultar(o)};
                }else{
                    throw new Exception("Acceso inválido.");
                }
            }
