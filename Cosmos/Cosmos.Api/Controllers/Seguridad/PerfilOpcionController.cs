...
{
    public partial class PerfilOpcionController : ApiController
    {
        #region CRUD
        
        [HttpPost]
        [Route("api/Seguridad/PerfilOpcion/Listado")]
        public RespuestaBase Listado(SolicitudBase solicitud) {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud)) {
                    ...
                    respuesta.Datos = Cosmos.Seguridad.Negocio.PerfilOpcion.Listado();
                }else{
        ...
        [HttpPost]
        [Route("api/Seguridad/PerfilOpcion/Guardar")]
        public RespuestaBase Guardar(SolicitudBase solicitud)
        {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud)) {                    
                    ...
                    respuesta.CodigoError = 0;
                    respuesta.MensajeError = "";
                    respuesta.Exitoso = Cosmos.Seguridad.Negocio.PerfilOpcion.Guardar(solicitud.UsuarioID, o);
                    respuesta.Datos = null;
                }else{
                    throw new Exception("Acceso inválido.");
                }
        ...
        [HttpPost]
        [Route("api/Seguridad/PerfilOpcion/Eliminar")]
        public RespuestaBase Eliminar(SolicitudBase solicitud)
        {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud)) {                    
                    ...
                    respuesta.CodigoError = 0;
                    respuesta.MensajeError = "";
                    respuesta.Exitoso = Cosmos.Seguridad.Negocio.PerfilOpcion.Eliminar(solicitud.UsuarioID, o);
                    respuesta.Datos = null;
                }else{
                    throw new Exception("Acceso inválido.");
                }
        ...
        [HttpPost]
        [Route("api/Seguridad/PerfilOpcion/Consultar")]
        public RespuestaBase Consultar(SolicitudBase solicitud) {
            ...
            try
            {
                if (Funciones.AccesoValido(solicitud)) {                    
                    ...
                    respuesta.MensajeError = "";
                    respuesta.Exitoso = true;
                    respuesta.Datos = new List<Cosmos.Seguridad.Entidades.PerfilOpcion>(){Cosmos.Seguridad.Negocio.PerfilOpcion.Consultar(o)};
                }else{
                    throw new Exception("Acceso inválido.");
                }
            }
