    ...
    {        
        ...
        public void Load(DataRow dr){
            if(dr!=null)            
            {
                ...
                String prefijoTabla = "ControlProductoAlmacen";
                
                //ControlProductoAlmacenID
                nombreColumna = EntidadesHelper.ColumnaDatosPropiedadEntidad(dr, "ControlProductoAlmacenID", prefijoTabla);
                if(!nombreColumna.Equals("")){this.ControlProductoAlmacenID =  CastHelper.CInt2(dr[nombreColumna]);}   
