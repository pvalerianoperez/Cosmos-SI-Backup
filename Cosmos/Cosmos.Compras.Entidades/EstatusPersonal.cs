    ...
    {        
        ...
        public void Load(DataRow dr){
            if(dr!=null)            
            {
                ...
                String prefijoTabla = "EstatusPersonal";
                ...
                //EstatusPersonalClave
                nombreColumna = EntidadesHelper.ColumnaDatosPropiedadEntidad(dr, "EstatusPersonalClave", prefijoTabla);
                if(!nombreColumna.Equals("")){this.EstatusPersonalClave =  CastHelper.CStr2(dr[nombreColumna]);}   
