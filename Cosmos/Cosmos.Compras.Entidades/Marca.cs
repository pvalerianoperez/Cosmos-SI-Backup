    ...
    {        
        ...
        public void Load(DataRow dr){
            if(dr!=null)            
            {
                ...
                //MarcaClave
                nombreColumna = EntidadesHelper.ColumnaDatosPropiedadEntidad(dr, "MarcaClave", prefijoTabla);
                if(!nombreColumna.Equals("")){this.MarcaClave =  CastHelper.CStr2(dr[nombreColumna]);}   
                ...
                if(!nombreColumna.Equals("")){this.Estatus =  CastHelper.CStr2(dr[nombreColumna]);}   
