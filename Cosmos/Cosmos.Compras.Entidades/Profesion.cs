...
namespace Cosmos.Compras.Entidades
{
    ...
    {        
        ...
        public string ProfesionClave { get; set; }            
        ...
        public void Load(DataRow dr){
            if(dr!=null)            
            {
                ...
                String prefijoTabla = "Profesion";
                
                //ProfesionID
                nombreColumna = EntidadesHelper.ColumnaDatosPropiedadEntidad(dr, "ProfesionID", prefijoTabla);
                if(!nombreColumna.Equals("")){this.ProfesionID =  CastHelper.CInt2(dr[nombreColumna]);}   
                
                //ProfesionClave
                nombreColumna = EntidadesHelper.ColumnaDatosPropiedadEntidad(dr, "ProfesionClave", prefijoTabla);
                if(!nombreColumna.Equals("")){this.ProfesionClave =  CastHelper.CStr2(dr[nombreColumna]);}   
