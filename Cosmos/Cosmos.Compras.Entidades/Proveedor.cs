...
namespace Cosmos.Compras.Entidades
{
    ...
    {        
        ...
        public int EspPersonaId { get; set; }
        ...
        public new void Load(DataRow dr){
            if(dr!=null)            
            {
                ...
                nombreColumna = Cosmos.Framework.EntidadesHelper.ColumnaDatosPropiedadEntidad(dr, "PpalProveedorID", "Proveedor");
                ...
                nombreColumna = Cosmos.Framework.EntidadesHelper.ColumnaDatosPropiedadEntidad(dr, "CmpTipoProveedorID", "Proveedor");
                ...
                nombreColumna = Cosmos.Framework.EntidadesHelper.ColumnaDatosPropiedadEntidad(dr, "AuxMedioContactoID", "Proveedor");
                if(!nombreColumna.Equals("")){this.MedioContactoID = Cosmos.Framework.CastHelper.CInt2(dr[nombreColumna]);}                
                nombreColumna = Cosmos.Framework.EntidadesHelper.ColumnaDatosPropiedadEntidad(dr, "AuxVinculoID", "Proveedor");
                if(!nombreColumna.Equals("")){this.VinculoID = Cosmos.Framework.CastHelper.CInt2(dr[nombreColumna]);}                

                //llenalo con la informacion de la base de datos
                nombreColumna = Cosmos.Framework.EntidadesHelper.ColumnaDatosPropiedadEntidad(dr, "EspPersonaID", "Proveedor");
                if (!nombreColumna.Equals("")) { this.PersonaID = Cosmos.Framework.CastHelper.CInt2(dr[nombreColumna]); }
                nombreColumna = Cosmos.Framework.EntidadesHelper.ColumnaDatosPropiedadEntidad(dr, "EspPersonaClave", "Proveedor");
