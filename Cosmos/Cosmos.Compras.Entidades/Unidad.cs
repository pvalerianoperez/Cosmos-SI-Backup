    ...
    {        
        ...
        public void Load(DataRow dr){
            if(dr!=null)            
            {
                ...
                //UnidadClave
                nombreColumna = EntidadesHelper.ColumnaDatosPropiedadEntidad(dr, "UnidadClave", prefijoTabla);
                if(!nombreColumna.Equals("")){this.UnidadClave =  CastHelper.CStr2(dr[nombreColumna]);}   
