...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="InstitucionEducativa_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Catalogos.Academico.InstitucionEducativa_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">
    ...
    <asp:ObjectDataSource ID="ods0" runat="server" SelectMethod="Listado" TypeName="Cosmos.Academico.Api.Client.InstitucionEducativa"></asp:ObjectDataSource>
    <dx:ASPxGridView ID="Grid" ClientInstanceName="Grid" runat="server" DataSourceID="ods0"
        AutoGenerateColumns="False" KeyFieldName="InstitucionEducativaID" Width="100%" OnBatchUpdate="Grid_BatchUpdate">
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="InstitucionEducativaID" VisibleIndex="1" Width="50px" ReadOnly="true" Visible="False">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Clave" FieldName="InstitucionEducativaClave" VisibleIndex="2" MinWidth="70" Width="70px">
            ...
            <dx:GridViewDataTextColumn Caption="Extra Decimal 1" FieldName="ExtraDecimal1" VisibleIndex="10" MinWidth="100">
                <PropertiesTextEdit MaxLength="10">
                </PropertiesTextEdit>
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>                  
            <dx:GridViewDataTextColumn Caption="Extra Decimal 2" FieldName="ExtraDecimal2" VisibleIndex="11" MinWidth="100">
                <PropertiesTextEdit MaxLength="10">
                </PropertiesTextEdit>
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>                  
            <dx:GridViewDataTextColumn Caption="Extra Decimal 3" FieldName="ExtraDecimal3" VisibleIndex="12" MinWidth="100">
                <PropertiesTextEdit MaxLength="10">
                </PropertiesTextEdit>
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>   
