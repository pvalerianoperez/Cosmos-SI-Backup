...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="Accion_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Catalogos.Seguridad.Accion_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">
    ...
    <asp:ObjectDataSource ID="ods0" runat="server" SelectMethod="Listado" TypeName="Cosmos.Seguridad.Api.Client.Accion"></asp:ObjectDataSource>
    <dx:ASPxGridView ID="Grid" ClientInstanceName="Grid" runat="server" DataSourceID="ods0"
        AutoGenerateColumns="False" KeyFieldName="AccionID" Width="100%" OnBatchUpdate="Grid_BatchUpdate">
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="AccionID" VisibleIndex="1" Width="50px" ReadOnly="true" Visible="False">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Accion Clave" FieldName="AccionClave" VisibleIndex="2" MinWidth="180" Width="180px">
