...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="Configuracion_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Catalogos.Seguridad.Configuracion_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">
    ...
    <asp:ObjectDataSource ID="ods0" runat="server" SelectMethod="Listado" TypeName="Cosmos.Seguridad.Api.Client.Configuracion"></asp:ObjectDataSource>
    <dx:ASPxGridView ID="Grid" ClientInstanceName="Grid" runat="server" DataSourceID="ods0"
        AutoGenerateColumns="False" KeyFieldName="ConfiguracionID" Width="100%" OnBatchUpdate="Grid_BatchUpdate">
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="ConfiguracionID" VisibleIndex="1" Width="50px" ReadOnly="true">
            ...
            <dx:GridViewDataSpinEditColumn VisibleIndex="3" Caption="Maximo Intentos Login" FieldName="MaximoIntentosLogin">
                <PropertiesSpinEdit DisplayFormatString="n0" MaxLength="5" NumberFormat="Number" DecimalPlaces="0">
                    <ClearButton Visibility="Auto">
                    </ClearButton>
                </PropertiesSpinEdit>
            </dx:GridViewDataSpinEditColumn>
            <dx:GridViewDataCheckColumn VisibleIndex="4" Caption="Activa" FieldName="Activa">
