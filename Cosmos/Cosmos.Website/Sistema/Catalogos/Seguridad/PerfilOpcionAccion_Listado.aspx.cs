...
{
    public partial class PerfilOpcionAccion_Listado : System.Web.UI.Page
    {        
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            switch (accion) {
                case "EXPORTAR_EXCEL":
                    ...
                    ASPxGridViewExporter1.WriteXlsxToResponse(string.Format("SistemaPerfilOpcionAccion_{0}.xlsx", DateTime.Now.ToString("yyMMddHHmmss")), true);
                    break;
                case "EXPORTAR_PDF":
                    ASPxGridViewExporter1.DataBind();
                    ASPxGridViewExporter1.WritePdfToResponse(string.Format("SistemaPerfilOpcionAccion_{0}.pdf", DateTime.Now.ToString("yyMMddHHmmss")), true);
                    break;
            }         
        }
        ...
        protected void Grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            for (int i = 0; i < e.UpdateValues.Count; i++)
            {
                ...
                int accionID = CastHelper.CInt2(e.UpdateValues[i].NewValues["AccionID"]);
                Cosmos.Seguridad.Api.Client.PerfilOpcionAccion.Guardar(perfilID, opcionID, accionID);
            }
            e.Handled = true;
            Grid.DataBind();
