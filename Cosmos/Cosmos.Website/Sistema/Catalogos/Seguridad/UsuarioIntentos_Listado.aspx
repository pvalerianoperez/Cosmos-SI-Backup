...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="UsuarioIntentos_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Catalogos.Seguridad.UsuarioIntentos_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">
    ...
    <asp:ObjectDataSource ID="ods0" runat="server" SelectMethod="Listado" TypeName="Cosmos.Seguridad.Api.Client.UsuarioIntentos"></asp:ObjectDataSource>
