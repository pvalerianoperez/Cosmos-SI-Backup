...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="NivelProducto_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Catalogos.Sistema.NivelProducto_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">
    ...
    <asp:ObjectDataSource ID="ods0" runat="server" SelectMethod="Listado" TypeName="Cosmos.Sistema.Api.Client.NivelProducto"></asp:ObjectDataSource>
    <dx:ASPxGridView ID="Grid" ClientInstanceName="Grid" runat="server" DataSourceID="ods0"
        AutoGenerateColumns="False" KeyFieldName="NivelProductoID" Width="100%" OnBatchUpdate="Grid_BatchUpdate">
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="NivelProductoID" VisibleIndex="1" Width="50px" ReadOnly="true">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Nivel Producto Clave" FieldName="NivelProductoClave" VisibleIndex="2" Width="40px">
