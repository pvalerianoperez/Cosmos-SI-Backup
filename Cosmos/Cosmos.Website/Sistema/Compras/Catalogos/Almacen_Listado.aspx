...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="Almacen_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Compras.Catalogos.Almacen_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">    
    ...
    <asp:ObjectDataSource ID="odsGrid" runat="server" SelectMethod="Listado" TypeName="Cosmos.Compras.Api.Client.Almacen">
        <SelectParameters>
    ...
    <dx:ASPxGridView ID="Grid" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="AlmacenID" VisibleIndex="1" Width="50px" ReadOnly="true" Visible="False">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Clave" FieldName="AlmacenClave" VisibleIndex="2" MinWidth="140" Width="140px">
            ...
            <dx:GridViewDataComboBoxColumn Caption="Sucursal" FieldName="SucursalID" VisibleIndex="5">
                <PropertiesComboBox DataSourceID="ObjectDataSource5" TextField="Nombre" ValueField="SucursalID">
...
<asp:ObjectDataSource ID="ObjectDataSource5" runat="server" SelectMethod="Listado" TypeName="Cosmos.Compras.Api.Client.Sucursal">
    <SelectParameters>
        <asp:SessionParameter Name="empresaID" SessionField="EmpresaID" Type="Int32" />
    </SelectParameters>
</asp:ObjectDataSource>
