...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="CentroCosto_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Compras.Catalogos.CentroCosto_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">    
    ...
    <asp:ObjectDataSource ID="odsGrid" runat="server" SelectMethod="Listado" TypeName="Cosmos.Compras.Api.Client.CentroCosto">
        <SelectParameters>
    ...
    <dx:ASPxGridView ID="Grid" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="CentroCostoID" VisibleIndex="1" Width="50px" ReadOnly="true" Visible="False">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataSpinEditColumn VisibleIndex="2" Caption="Empresa ID" FieldName="EmpresaID" MinWidth="100" Width="100px" Visible="false">
            ...
            <dx:GridViewDataTextColumn Caption="Clave" FieldName="CentroCostoClave" VisibleIndex="3" MinWidth="92" Width="92px">
            ...
            <dx:GridViewDataTextColumn Caption="Nombre" FieldName="Nombre" VisibleIndex="4" MinWidth="350" Width="350px">
            ...
            <dx:GridViewDataTextColumn Caption="Nombre Corto" FieldName="NombreCorto" VisibleIndex="5" MinWidth="150" Width="150px">
            ...
            <dx:GridViewDataTextColumn Caption="Administracion" FieldName="Administracion" VisibleIndex="6" MinWidth="70">
