...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="Ciudad_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Compras.Catalogos.Ciudad_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">    
    ...
    <asp:ObjectDataSource ID="odsGrid" runat="server" SelectMethod="Listado" TypeName="Cosmos.Compras.Api.Client.Ciudad"></asp:ObjectDataSource>
    <dx:ASPxGridView ID="Grid" 
        ClientInstanceName="Grid" 
        runat="server" 
        DataSourceID="odsGrid" 
        AutoGenerateColumns="False" 
        KeyFieldName="CiudadID"
        Width="100%" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="CiudadID" VisibleIndex="1" Width="50px" ReadOnly="true" Visible="False">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Clave" FieldName="CiudadClave" VisibleIndex="2" MinWidth="92" Width="92px">
            ...
            <dx:GridViewDataComboBoxColumn Caption="Municipio" FieldName="MunicipioID" VisibleIndex="5" Visible="false">
                <PropertiesComboBox DataSourceID="ObjectDataSource5" TextField="Nombre" ValueField="MunicipioID" >
...
<asp:ObjectDataSource ID="ObjectDataSource5" runat="server" SelectMethod="Listado" TypeName="Cosmos.Compras.Api.Client.Municipio"></asp:ObjectDataSource>
