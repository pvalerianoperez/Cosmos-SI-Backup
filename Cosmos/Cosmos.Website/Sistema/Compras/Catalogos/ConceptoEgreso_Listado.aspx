...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="ConceptoEgreso_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Compras.Catalogos.ConceptoEgreso_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">    
    ...
    <asp:ObjectDataSource ID="odsGrid" runat="server" SelectMethod="Listado" TypeName="Cosmos.Compras.Api.Client.ConceptoEgreso">
        <SelectParameters>
    ...
    <dx:ASPxGridView ID="Grid" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="ConceptoEgresoID" VisibleIndex="1" Width="50px" ReadOnly="true" Visible="False">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Clave" FieldName="ConceptoEgresoClave" VisibleIndex="2" MinWidth="78" Width="78px">
            ...
            <dx:GridViewDataTextColumn Caption="Compra Factura" FieldName="CompraFactura" VisibleIndex="5" MinWidth="100" Width="100px">
            ...
            <dx:GridViewDataTextColumn Caption="Desglosar" FieldName="Desglosar" VisibleIndex="6" MinWidth="70">
                <PropertiesTextEdit MaxLength="1">
                    <ValidationSettings>
                        <RequiredField IsRequired="true" ErrorText="El dato es requerido" />
                    </ValidationSettings>
