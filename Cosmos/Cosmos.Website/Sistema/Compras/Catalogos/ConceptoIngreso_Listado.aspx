...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="ConceptoIngreso_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Compras.Catalogos.ConceptoIngreso_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">    
    ...
    <asp:ObjectDataSource ID="odsGrid" runat="server" SelectMethod="Listado" TypeName="Cosmos.Compras.Api.Client.ConceptoIngreso">
        <SelectParameters>
    ...
    <dx:ASPxGridView ID="Grid" 
        ...
        KeyFieldName="ConceptoIngresoID"
        Width="100%" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="ConceptoIngresoID" VisibleIndex="1" Width="50px" ReadOnly="true" Visible="False">
