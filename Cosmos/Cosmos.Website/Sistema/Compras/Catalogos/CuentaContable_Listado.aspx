...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="CuentaContable_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Compras.Catalogos.CuentaContable_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">    
    ...
    <asp:ObjectDataSource ID="odsGrid" runat="server" SelectMethod="Listado" TypeName="Cosmos.Compras.Api.Client.CuentaContable"></asp:ObjectDataSource>
    <dx:ASPxGridView ID="Grid" 
        ClientInstanceName="Grid" 
        runat="server" 
        DataSourceID="odsGrid" 
        AutoGenerateColumns="False" 
        KeyFieldName="CuentaContableID"
        Width="100%" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="CuentaContableID" VisibleIndex="1" Width="50px" ReadOnly="true" Visible="False">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Clave" FieldName="CuentaContableClave" VisibleIndex="2" MinWidth="210" Width="210px">
            ...
            <dx:GridViewDataComboBoxColumn Caption="Cuenta Contable Padre" FieldName="PerteneceCuentaContableID" VisibleIndex="4" MinWidth="100">
                <PropertiesComboBox TextField="Nombre" DataSourceID="odsGrid" ValueField="CuentaContableID" AllowNull="true" ConvertEmptyStringToNull="true" >
