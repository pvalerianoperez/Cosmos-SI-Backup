...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="Estado_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Compras.Catalogos.Estado_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">    
    ...
    <script type="text/javascript">        
        ...
        function EditarDetalles(id) {
            window.parent.EditarDetallesMunicipios(id);
        }
    </script>    
    <dx:ASPxGridViewExporter ID="ASPxGridViewExporter1" runat="server" GridViewID="Grid"></dx:ASPxGridViewExporter>
    <asp:ObjectDataSource ID="odsGrid" runat="server" SelectMethod="Listado" TypeName="Cosmos.Compras.Api.Client.Estado"></asp:ObjectDataSource>
    <dx:ASPxGridView ID="Grid" 
        ClientInstanceName="Grid" 
        runat="server" 
        DataSourceID="odsGrid" 
        AutoGenerateColumns="False" 
        KeyFieldName="EstadoID"
        Width="100%" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="EstadoID" VisibleIndex="1" Width="50px" ReadOnly="true" Visible="False">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Clave" FieldName="EstadoClave" VisibleIndex="2" MinWidth="92" Width="92px">
            ...
            <dx:GridViewDataComboBoxColumn Caption="Pais" FieldName="PaisID" VisibleIndex="5" Visible="false">
                <PropertiesComboBox DataSourceID="ObjectDataSource5" TextField="Nombre" ValueField="PaisID">
            ...
            <dx:GridViewDataHyperLinkColumn Caption=" " FieldName="EstadoID" VisibleIndex="5">
                <PropertiesHyperLinkEdit NavigateUrlFormatString="javascript:EditarDetalles({0});" Text="Municipios">
...
<asp:ObjectDataSource ID="ObjectDataSource5" runat="server" SelectMethod="Listado" TypeName="Cosmos.Compras.Api.Client.Pais"></asp:ObjectDataSource>
