...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="Fecha_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Compras.Catalogos.Fecha_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">    
    ...
    <asp:ObjectDataSource ID="odsGrid" runat="server" SelectMethod="Listado" TypeName="Cosmos.Compras.Api.Client.Fecha"></asp:ObjectDataSource>
    <dx:ASPxGridView ID="Grid" 
        ClientInstanceName="Grid" 
        runat="server" 
        DataSourceID="odsGrid" 
        AutoGenerateColumns="False" 
        KeyFieldName="FechaID"
        Width="100%" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="FechaID" VisibleIndex="1" Width="50px" ReadOnly="true" Visible="False">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataDateColumn VisibleIndex="2" Caption="Valor" FieldName="Valor" MinWidth="200" Width="200px">
            ...
            <dx:GridViewDataComboBoxColumn Caption="Persona" FieldName="PersonaID" VisibleIndex="3">
                <PropertiesComboBox DataSourceID="ObjectDataSource3" TextField="Nombre" ValueField="PersonaID">
                    <ClearButton Visibility="Auto">
                    </ClearButton>
                    <ValidationSettings>
                        <RequiredField IsRequired="true" ErrorText="El dato es requerido" />
            ...
            <dx:GridViewDataComboBoxColumn Caption="Tipo Fecha" FieldName="TipoFechaID" VisibleIndex="4">
                <PropertiesComboBox DataSourceID="ObjectDataSource4" TextField="Nombre" ValueField="TipoFechaID">
                    <ClearButton Visibility="Auto">
                    </ClearButton>
                    <ValidationSettings>
                        <RequiredField IsRequired="true" ErrorText="El dato es requerido" />
            ...
            <dx:GridViewDataTextColumn Caption="Comentario" FieldName="Comentario" VisibleIndex="5" MinWidth="260">
...
<asp:ObjectDataSource ID="ObjectDataSource3" runat="server" SelectMethod="Listado" TypeName="Cosmos.Compras.Api.Client.Personal"></asp:ObjectDataSource>
<asp:ObjectDataSource ID="ObjectDataSource4" runat="server" SelectMethod="Listado" TypeName="Cosmos.Compras.Api.Client.TipoFecha"></asp:ObjectDataSource>
