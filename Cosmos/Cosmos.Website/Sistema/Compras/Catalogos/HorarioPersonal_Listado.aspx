...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="HorarioPersonal_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Compras.Catalogos.HorarioPersonal_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">    
    ...
    <asp:ObjectDataSource ID="odsGrid" runat="server" SelectMethod="Listado" TypeName="Cosmos.Compras.Api.Client.HorarioPersonal">
        <SelectParameters>
    ...
    <dx:ASPxGridView ID="Grid" 
        ...
        KeyFieldName="HorarioPersonalID"
        Width="100%" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="HorarioPersonalID" VisibleIndex="1" Width="50px" ReadOnly="true" Visible="False">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Clave" FieldName="HorarioPersonalClave" VisibleIndex="2" MinWidth="106" Width="106px">
