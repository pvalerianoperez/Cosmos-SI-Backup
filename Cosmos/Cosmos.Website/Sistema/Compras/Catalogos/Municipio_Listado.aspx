...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="Municipio_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Compras.Catalogos.Municipio_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">    
    ...
    <script type="text/javascript">        
        ...
        function EditarDetalles(id) {
            //popupDetalles.SetContentUrl('Ciudad_Listado.aspx?hidenavigation=1&MunicipioID=' + id)
            //popupDetalles.Show();
            window.parent.EditarDetallesCiudades(id);
        }
    </script>   
    <dx:ASPxGridViewExporter ID="ASPxGridViewExporter1" runat="server" GridViewID="Grid"></dx:ASPxGridViewExporter>
    <asp:ObjectDataSource ID="odsGrid" runat="server" SelectMethod="Listado" TypeName="Cosmos.Compras.Api.Client.Municipio"></asp:ObjectDataSource>
    <dx:ASPxGridView ID="Grid" 
        ClientInstanceName="Grid" 
        runat="server" 
        DataSourceID="odsGrid" 
        AutoGenerateColumns="False" 
        KeyFieldName="MunicipioID"
        Width="100%" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="MunicipioID" VisibleIndex="1" Width="50px" ReadOnly="true" Visible="False">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Clave" FieldName="MunicipioClave" VisibleIndex="2" MinWidth="92" Width="92px">
            ...
            <dx:GridViewDataComboBoxColumn Caption="Estado" FieldName="EstadoID" VisibleIndex="5" Visible="false">
                <PropertiesComboBox DataSourceID="ObjectDataSource5" TextField="Nombre" ValueField="EstadoID">
            ...
            <dx:GridViewDataHyperLinkColumn Caption=" " FieldName="MunicipioID" VisibleIndex="5">
                <PropertiesHyperLinkEdit NavigateUrlFormatString="javascript:EditarDetalles({0});" Text="Ciudades">
...
<asp:ObjectDataSource ID="ObjectDataSource5" runat="server" SelectMethod="Listado" TypeName="Cosmos.Compras.Api.Client.Estado"></asp:ObjectDataSource>
