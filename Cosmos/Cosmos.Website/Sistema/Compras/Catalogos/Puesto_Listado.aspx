...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="Puesto_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Compras.Catalogos.Puesto_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">    
    ...
    <asp:ObjectDataSource ID="odsGrid" runat="server" SelectMethod="Listado" TypeName="Cosmos.Compras.Api.Client.Puesto">
        <SelectParameters>
    ...
    <dx:ASPxGridView ID="Grid" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="PuestoID" VisibleIndex="1" Width="50px" ReadOnly="true" Visible="False">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Clave" FieldName="PuestoClave" VisibleIndex="2" MinWidth="106" Width="106px">
            ...
            <dx:GridViewDataSpinEditColumn VisibleIndex="5" Caption="Sueldo" FieldName="Sueldo" MinWidth="150" Width="150px">
            ...
            <dx:GridViewDataTextColumn Caption="Base Neto" FieldName="BaseNeto" VisibleIndex="6" MinWidth="70" Width="70px">
            ...
            <dx:GridViewDataTextColumn Caption="Tipo" FieldName="Tipo" VisibleIndex="7" MinWidth="70" Width="70px">
                <PropertiesTextEdit MaxLength="1">
                    <ValidationSettings>
                        <RequiredField IsRequired="true" ErrorText="El dato es requerido" />
                    </ValidationSettings>
            ...
            <dx:GridViewDataTextColumn Caption="Objetivo" FieldName="Objetivo" VisibleIndex="8" MinWidth="500" Width="500px">
            ...
            <dx:GridViewDataTextColumn Caption="Req Academicos" FieldName="ReqAcademicos" VisibleIndex="9" MinWidth="500" Width="500px">
            ...
            <dx:GridViewDataSpinEditColumn VisibleIndex="10" Caption="Tiempo Desempeno" FieldName="TiempoDesempeno" MinWidth="150" Width="150px">
