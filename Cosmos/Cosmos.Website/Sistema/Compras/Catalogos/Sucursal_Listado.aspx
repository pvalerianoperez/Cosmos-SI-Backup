...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="Sucursal_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Catalogos.Compras.Sucursal_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">
    ...
    <asp:ObjectDataSource ID="ods0" runat="server" SelectMethod="Listado" TypeName="Cosmos.Compras.Api.Client.Sucursal">
        <SelectParameters>
    ...
    <dx:ASPxGridView ID="Grid" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="SucursalID" VisibleIndex="2" Width="50px" ReadOnly="true" Visible="False">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Clave" FieldName="SucursalClave" VisibleIndex="3" MinWidth="70" Width="70px">
            ...
            <dx:GridViewDataTextColumn Caption="Nombre Corto" FieldName="NombreCorto" VisibleIndex="5">
