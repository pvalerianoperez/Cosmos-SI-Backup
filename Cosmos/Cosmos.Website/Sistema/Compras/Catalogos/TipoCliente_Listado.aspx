...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="TipoCliente_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Compras.Catalogos.TipoCliente_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">    
    <script type="text/javascript">
        function AccionMenuItemClick(e) {
            switch (e.item.name) {
                ...
                case "ELIMINAR":
                case "IMPRIMIR":
                    var reportURL = "/Recursos/Reportes/ReportViewer.aspx?Reporte=Compras.Reportes.TipoCliente";
                    window.open(reportURL, 'winname', "directories=0,titlebar=0,toolbar=0,location=0,status=0,menubar=0,scrollbars=no,resizable=yes,width=800,height=500");
                    break;
                case "EXPORTAR_PDF":
                case "EXPORTAR_EXCEL":
                case "AUTORIZAR":
    ...
    <asp:ObjectDataSource ID="odsGrid" runat="server" SelectMethod="Listado" TypeName="Cosmos.Compras.Api.Client.TipoCliente"></asp:ObjectDataSource>
    <dx:ASPxGridView ID="Grid" 
        ClientInstanceName="Grid" 
        runat="server" 
        DataSourceID="odsGrid" 
        AutoGenerateColumns="False" 
        KeyFieldName="TipoClienteID"
        Width="100%" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="TipoClienteID" VisibleIndex="1" Width="50px" ReadOnly="true" Visible="False">
