...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="TipoHorario_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Compras.Catalogos.TipoHorario_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">    
    ...
    <asp:ObjectDataSource ID="odsGrid" runat="server" SelectMethod="Listado" TypeName="Cosmos.Compras.Api.Client.TipoHorario">
        <SelectParameters>
    ...
    <dx:ASPxGridView ID="Grid" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="TipoHorarioID" VisibleIndex="1" Width="50px" ReadOnly="true" Visible="False">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Clave" FieldName="TipoHorarioClave" VisibleIndex="2" MinWidth="120" Width="120px">
            ...
            <dx:GridViewDataSpinEditColumn VisibleIndex="5" Caption="Empresa ID" FieldName="EmpresaID" MinWidth="100" Width="100px" Visible="false">
            ...
            <dx:GridViewDataTextColumn Caption="Homogeneo" FieldName="Homogeneo" VisibleIndex="6" MinWidth="70">
