...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="TipoMovimientoProveedor_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Compras.Catalogos.TipoMovimientoProveedor_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">    
    ...
    <asp:ObjectDataSource ID="odsGrid" runat="server" SelectMethod="Listado" TypeName="Cosmos.Compras.Api.Client.TipoMovimientoProveedor"></asp:ObjectDataSource>
    <asp:ObjectDataSource ID="odsNaturaleza" runat="server" SelectMethod="Listado" TypeName="Cosmos.Sistema.Api.Client.Naturaleza"></asp:ObjectDataSource>
    <dx:ASPxGridView ID="Grid" 
        ClientInstanceName="Grid" 
        runat="server" 
        DataSourceID="odsGrid" 
        AutoGenerateColumns="False" 
        KeyFieldName="TipoMovimientoProveedorID"
        Width="100%" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="TipoMovimientoProveedorID" VisibleIndex="1" Width="50px" ReadOnly="true" Visible="False">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Clave" FieldName="TipoMovimientoProveedorClave" VisibleIndex="2" MinWidth="120" Width="120px">
            ...
            <dx:GridViewDataComboBoxColumn Caption="Naturaleza" FieldName="NaturalezaID" MinWidth="150" VisibleIndex="5">
                <PropertiesComboBox DisplayFormatString="g" MaxLength="5" DataSourceID="odsNaturaleza" TextField="Nombre" ValueField="NaturalezaID">
                    <ValidationSettings>
