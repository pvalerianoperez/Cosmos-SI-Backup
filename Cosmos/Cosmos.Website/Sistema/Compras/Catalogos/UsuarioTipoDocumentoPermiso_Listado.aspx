...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="UsuarioTipoDocumentoPermiso_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Compras.Catalogos.UsuarioTipoDocumentoPermiso_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">    
    ...
    <asp:ObjectDataSource ID="odsGrid" runat="server" SelectMethod="Listado" TypeName="Cosmos.Compras.Api.Client.UsuarioTipoDocumentoPermiso"></asp:ObjectDataSource>
    <dx:ASPxGridView ID="Grid" 
        ClientInstanceName="Grid" 
        runat="server" 
        DataSourceID="odsGrid" 
        AutoGenerateColumns="False" 
        KeyFieldName="UsuarioTipoDocumentoPermisoID"
        Width="100%" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="UsuarioTipoDocumentoPermisoID" VisibleIndex="1" Width="50px" ReadOnly="true" Visible="False">
            ...
            <dx:GridViewDataComboBoxColumn Caption="Empresa" FieldName="EmpresaID" VisibleIndex="6" Visible="false">
                <PropertiesComboBox DataSourceID="ObjectDataSource6" TextField="Nombre" ValueField="EmpresaID">
                    <ClearButton Visibility="Auto">
                    </ClearButton>
                </PropertiesComboBox>
            </dx:GridViewDataComboBoxColumn>
            ...
            <dx:GridViewDataSpinEditColumn VisibleIndex="8" Caption="Sucursal ID" FieldName="SucursalID" MinWidth="100" Width="100px">
            ...
            <dx:GridViewDataCheckColumn VisibleIndex="9" Caption="Preautoriza" FieldName="Preautoriza" MinWidth="70" Width="70px">
                <PropertiesCheckEdit DisplayFormatString="g">
                </PropertiesCheckEdit>
                <CellStyle HorizontalAlign="Center" />                
                <HeaderStyle HorizontalAlign="Center" />
            </dx:GridViewDataCheckColumn>
            <dx:GridViewDataSpinEditColumn VisibleIndex="10" Caption="Preautorizar Monto" FieldName="PreautorizarMonto" MinWidth="100" Width="100px">
            ...
            <dx:GridViewDataCheckColumn VisibleIndex="11" Caption="Autoriza" FieldName="Autoriza" MinWidth="70" Width="70px">
                <PropertiesCheckEdit DisplayFormatString="g">
                </PropertiesCheckEdit>
                <CellStyle HorizontalAlign="Center" />                
                <HeaderStyle HorizontalAlign="Center" />
            </dx:GridViewDataCheckColumn>
            <dx:GridViewDataSpinEditColumn VisibleIndex="12" Caption="Autorizar Monto" FieldName="AutorizarMonto" MinWidth="100">
                <PropertiesSpinEdit DisplayFormatString="c2" MaxLength="10" NumberFormat="Number" DecimalPlaces="2">
                    <ClearButton Visibility="Auto">
                    </ClearButton>
                </PropertiesSpinEdit>
