...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="LogRegla_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Sistema.Catalogos.LogRegla_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">    
    ...
    <asp:ObjectDataSource ID="odsGrid" runat="server" SelectMethod="Listado" TypeName="Cosmos.Sistema.Api.Client.LogRegla"></asp:ObjectDataSource>
    <dx:ASPxGridView ID="Grid" 
        ClientInstanceName="Grid" 
        runat="server" 
        DataSourceID="odsGrid" 
        AutoGenerateColumns="False" 
        KeyFieldName="SistemaLogReglaID"
        Width="100%" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="SistemaLogReglaID" VisibleIndex="1" Width="50px" ReadOnly="true" Visible="False">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataSpinEditColumn VisibleIndex="2" Caption="User ID" FieldName="UserID" MinWidth="150" Width="150px">
            ...
            <dx:GridViewDataTextColumn Caption="Tabla Nombre" FieldName="TablaNombre" VisibleIndex="3" MinWidth="400" Width="400px">
            ...
            <dx:GridViewDataCheckColumn VisibleIndex="4" Caption="C" FieldName="C" MinWidth="70" Width="70px">
                <PropertiesCheckEdit DisplayFormatString="g">
                </PropertiesCheckEdit>
                <CellStyle HorizontalAlign="Center" />                
                <HeaderStyle HorizontalAlign="Center" />
            </dx:GridViewDataCheckColumn>
            <dx:GridViewDataCheckColumn VisibleIndex="5" Caption="R" FieldName="R" MinWidth="70" Width="70px">
                <PropertiesCheckEdit DisplayFormatString="g">
                </PropertiesCheckEdit>
                <CellStyle HorizontalAlign="Center" />                
                <HeaderStyle HorizontalAlign="Center" />
            </dx:GridViewDataCheckColumn>
            <dx:GridViewDataCheckColumn VisibleIndex="6" Caption="U" FieldName="U" MinWidth="70" Width="70px">
                <PropertiesCheckEdit DisplayFormatString="g">
                </PropertiesCheckEdit>
                <CellStyle HorizontalAlign="Center" />                
                <HeaderStyle HorizontalAlign="Center" />
            </dx:GridViewDataCheckColumn>
            <dx:GridViewDataCheckColumn VisibleIndex="7" Caption="D" FieldName="D" MinWidth="70">
                <PropertiesCheckEdit DisplayFormatString="g">
                </PropertiesCheckEdit>
