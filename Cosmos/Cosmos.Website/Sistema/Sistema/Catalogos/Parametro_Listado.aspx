...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="Parametro_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Sistema.Catalogos.Parametro_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">    
    ...
    <asp:ObjectDataSource ID="odsGrid" runat="server" SelectMethod="Listado" TypeName="Cosmos.Sistema.Api.Client.Parametro"></asp:ObjectDataSource>
    ...
    <dx:ASPxGridView ID="Grid" 
        ...
        KeyFieldName="SistemaParametroID"
        Width="100%" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="SistemaParametroID" VisibleIndex="1" Width="50px" ReadOnly="true" Visible="False">
            ...
            <dx:GridViewDataComboBoxColumn Caption="Módulo" FieldName="ModuloID" MinWidth="150" VisibleIndex="3">
            ...
            <dx:GridViewDataTextColumn Caption="Valor" FieldName="Valor" VisibleIndex="4" MinWidth="190">
