...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="PersonalTipoContacto_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Sistema.Catalogos.PersonalTipoContacto_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">    
    ...
    <asp:ObjectDataSource ID="odsGrid" runat="server" SelectMethod="Listado" TypeName="Cosmos.Sistema.Api.Client.PersonalTipoContacto"></asp:ObjectDataSource>
    <dx:ASPxGridView ID="Grid" 
        ClientInstanceName="Grid" 
        runat="server" 
        DataSourceID="odsGrid" 
        AutoGenerateColumns="False" 
        KeyFieldName="PersonalTipoContactoID"
        Width="100%" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="PersonalTipoContactoID" VisibleIndex="1" Width="50px" ReadOnly="true" Visible="False">
            ...
            <dx:GridViewDataTextColumn Caption="Nombre Corto" FieldName="NombreCorto" VisibleIndex="3" MinWidth="150" Width="150px">
            ...
            <dx:GridViewDataCheckColumn VisibleIndex="4" Caption="Conyuge" FieldName="Conyuge" MinWidth="70">
