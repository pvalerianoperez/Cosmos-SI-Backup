...
{
    public partial class PersonalTipoContacto_Listado : System.Web.UI.Page
    {        
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            switch (accion) {
                case "EXPORTAR_EXCEL":
                    ...
                    ASPxGridViewExporter1.WriteXlsxToResponse(string.Format("SistemaPersonalTipoContacto_{0}.xlsx", DateTime.Now.ToString("yyMMddHHmmss")), true);
                    break;
                case "EXPORTAR_PDF":
                    ASPxGridViewExporter1.DataBind();
                    ASPxGridViewExporter1.WritePdfToResponse(string.Format("SistemaPersonalTipoContacto_{0}.pdf", DateTime.Now.ToString("yyMMddHHmmss")), true);
                    break;
            } 
        ...
        protected void Grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (((SitioProtegido)this.Master).PermisoAccion("AGREGAR"))
            {
                ...
                {
                    int personalTipoContactoID = CastHelper.CInt2(e.InsertValues[i].NewValues["PersonalTipoContactoID"]);
                    ...
                    bool conyuge = CastHelper.CBool2(e.InsertValues[i].NewValues["Conyuge"]);
                    Cosmos.Sistema.Api.Client.PersonalTipoContacto.Guardar(personalTipoContactoID, nombre, nombreCorto, conyuge);
                }
            }
            //update
            if (((SitioProtegido)this.Master).PermisoAccion("MODIFICAR"))
            {
                ...
                {
                    int personalTipoContactoID = CastHelper.CInt2(e.UpdateValues[i].Keys["PersonalTipoContactoID"]);
                    ...
                    bool conyuge = CastHelper.CBool2(e.UpdateValues[i].NewValues["Conyuge"]);
                    Cosmos.Sistema.Api.Client.PersonalTipoContacto.Guardar(personalTipoContactoID, nombre, nombreCorto, conyuge);
                }
            }
            //delete
            if (((SitioProtegido)this.Master).PermisoAccion("ELIMINAR"))
            {
                ...
                {
                    int personalTipoContactoID = CastHelper.CInt2(e.DeleteValues[i].Values["PersonalTipoContactoID"]);
                    Cosmos.Sistema.Api.Client.PersonalTipoContacto.Eliminar(personalTipoContactoID);
                }
            }
            e.Handled = true;
            Grid.DataBind();
