...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="TipoDocumentoRegla_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Sistema.Catalogos.TipoDocumentoRegla_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">    
    ...
    <asp:ObjectDataSource ID="odsGrid" runat="server" SelectMethod="Listado" TypeName="Cosmos.Sistema.Api.Client.TipoDocumentoRegla"></asp:ObjectDataSource>
    <dx:ASPxGridView ID="Grid" 
        ClientInstanceName="Grid" 
        runat="server" 
        DataSourceID="odsGrid" 
        AutoGenerateColumns="False" 
        KeyFieldName="TipoDocumentoReglaID"
        Width="100%" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="TipoDocumentoReglaID" VisibleIndex="1" Width="50px" ReadOnly="true" Visible="False">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataComboBoxColumn Caption="Sistema Estatus Tipo Documento" FieldName="SistemaEstatusTipoDocumentoID" VisibleIndex="2">
                <PropertiesComboBox DataSourceID="ObjectDataSource2" TextField="Nombre" ValueField="SistemaEstatusTipoDocumentoID">
            ...
            <dx:GridViewDataSpinEditColumn VisibleIndex="3" Caption="Sistema Estatus Tipo Documento IDPermite" FieldName="SistemaEstatusTipoDocumentoIDPermite" MinWidth="150">
