...
<%@ Page Title="" Language="C#" MasterPageFile="~/Recursos/MasterPages/SitioProtegido.Master" AutoEventWireup="true" CodeBehind="TipoDocumento_Listado.aspx.cs" Inherits="Cosmos.Website.Sistema.Sistema.Catalogos.TipoDocumento_Listado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">    
    ...
    <asp:ObjectDataSource ID="odsGrid" runat="server" SelectMethod="Listado" TypeName="Cosmos.Sistema.Api.Client.TipoDocumento"></asp:ObjectDataSource>
    ...
    <dx:ASPxGridView ID="Grid" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="TipoDocumentoID" VisibleIndex="1" Width="50px" ReadOnly="true" Visible="False">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Clave" FieldName="TipoDocumentoClave" VisibleIndex="2" MinWidth="120" Width="120px">
            ...
            <dx:GridViewDataCheckColumn VisibleIndex="5" Caption="Estatus" FieldName="Estatus" MinWidth="70" Width="70px">
                <PropertiesCheckEdit DisplayFormatString="g">
                </PropertiesCheckEdit>
                <CellStyle HorizontalAlign="Center" />                
                <HeaderStyle HorizontalAlign="Center" />
            </dx:GridViewDataCheckColumn>
            <dx:GridViewDataComboBoxColumn Caption="Módulo" FieldName="ModuloID" MinWidth="150" VisibleIndex="6">
